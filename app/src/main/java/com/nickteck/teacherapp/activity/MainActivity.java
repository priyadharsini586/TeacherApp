...
import com.nickteck.teacherapp.fragment.DashBoardFragment;
import com.nickteck.teacherapp.fragment.NotesFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_attendence) {
            ...
            AdditionalClass.replaceFragment(attendenceFragment,Constants.ATTENDENCEFRAGMENT,MainActivity.this);
        } else if (id == R.id.nav_notes) {
            NotesFragment notesFragment = new NotesFragment();
            AdditionalClass.replaceFragment(notesFragment,Constants.NOTESFRAGMENT,MainActivity.this);
